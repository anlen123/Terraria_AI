	...
	public class ArmorIDs
	{
		...
		public class Head
		{
			...
			public class Sets
			{
				...
				public static int[] FrontToBackID = ArmorIDs.Head.Sets.Factory.CreateIntSet(-1, new int[]
				{
					242,
					246,
					243,
				...
				public static bool[] UseSkinColor = ArmorIDs.Head.Sets.Factory.CreateBoolSet(false, new int[]
				{
					274,
					277
				});
				...
				public static bool[] HidesHead = ArmorIDs.Head.Sets.Factory.CreateBoolSet(false, new int[]
				{
					38,
					135,
					269,
				...
				public static bool[] PreventBeardDraw = ArmorIDs.Head.Sets.Factory.CreateBoolSet(false, new int[]
				{
					118,
					119,
					107,
				...
				public static bool[] UseAltFaceHeadDraw = ArmorIDs.Head.Sets.Factory.CreateBoolSet(false, new int[]
				{
					3,
					4,
					6,
				...
				public static bool[] CanDrawOnVelociraptorMount = ArmorIDs.Head.Sets.Factory.CreateBoolSet(false, new int[]
				{
					212,
					241,
					274,
		...
		public class Body
		{
			...
			public class Sets
			{
				...
				public static int[] IncludedCapeBack = ArmorIDs.Body.Sets.Factory.CreateIntSet(-1, new int[]
				{
					207,
					13,
					206,
				...
				public static int[] IncludedCapeBackFemale = ArmorIDs.Body.Sets.Factory.CreateIntSet(-1, new int[]
				{
					207,
					13,
					206,
				...
				public static int[] IncludedCapeFront = ArmorIDs.Body.Sets.Factory.CreateIntSet(-1, new int[]
				{
					184,
					6,
					248,
				...
				{
					85,
					new ArmorIDs.Body.Sets.IncludeCapeFrontAndBackInfo
					{
						backCape = 20,
						frontCape = 7
					},
				...
				public static bool[] UsesNewFramingCode = ArmorIDs.Body.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					2,
					3,
				...
				public static bool[] HidesShouldersAsCoat = ArmorIDs.Body.Sets.Factory.CreateBoolSet(new int[]
				{
					251
				});

				// Token: 0x040077A4 RID: 30628
				public static bool[] showsShouldersWhileJumping = ArmorIDs.Body.Sets.Factory.CreateBoolSet(new int[]
				{
					177,
					190,
					95,
				...
				public static bool[] shouldersAreAlwaysInTheBack = ArmorIDs.Body.Sets.Factory.CreateBoolSet(new int[]
				{
					190
				});

				// Token: 0x040077A6 RID: 30630
				public static bool[] DisableHandOnAndOffAccDraw = ArmorIDs.Body.Sets.Factory.CreateBoolSet(new int[]
				{
					83
				});

				// Token: 0x040077A7 RID: 30631
				public static bool[] DisableBeltAccDraw = ArmorIDs.Body.Sets.Factory.CreateBoolSet(new int[]
				{
					83,
					82
				});
				...
				public struct IncludeCapeFrontAndBackInfo
				{
					...
					// (get) Token: 0x06004DA7 RID: 19879 RVA: 0x006DB1B3 File Offset: 0x006D93B3
					public bool Invalid
					{
						get
						{
							return this.frontCape == -1 && this.backCape == -1;
						}
					}
		...
		public class Legs
		{
			...
			public class Sets
			{
				...
				public static bool[] IncompatibleWithFrogLeg = ArmorIDs.Legs.Sets.Factory.CreateBoolSet(new int[]
				{
					106,
					143,
					217,
				...
				public static bool[] TreatRobeExtensionLikeNormalLegsWhenSitting = ArmorIDs.Legs.Sets.Factory.CreateBoolSet(new int[]
				{
					101,
					102,
					118,
		...
		public class HandOn
		{
			...
			public class Sets
			{
				...
				public static bool[] UsesNewFramingCode = ArmorIDs.HandOn.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					2,
					3,
				...
				public static bool[] UsesOldFramingTexturesForWalking = ArmorIDs.HandOn.Sets.Factory.CreateBoolSet(false, new int[]
				{
					12,
					8,
					17
		...
		public class HandOff
		{
			...
			public class Sets
			{
				...
				public static bool[] UsesNewFramingCode = ArmorIDs.HandOff.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					2,
					3,
		...
		public class Back
		{
			...
			public class Sets
			{
				...
				public static bool[] DrawInBackpackLayer = ArmorIDs.Back.Sets.Factory.CreateBoolSet(false, new int[]
				{
					7,
					8,
					9,
				...
				public static bool[] DrawInTailLayer = ArmorIDs.Back.Sets.Factory.CreateBoolSet(false, new int[]
				{
					18,
					19,
					21,
				...
				public static bool[] IsACape = ArmorIDs.Back.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					2,
					3,
		...
		public class Front
		{
			...
			public class Sets
			{
				...
				public static bool[] DrawsInNeckLayer = ArmorIDs.Front.Sets.Factory.CreateBoolSet(false, new int[]
				{
					6
				});

				// Token: 0x040077B7 RID: 30647
				public static bool[] DrawsInNeckLayerRegardlessOfPlayerFrame = ArmorIDs.Front.Sets.Factory.CreateBoolSet(false, new int[]
				{
					13
				});

				// Token: 0x040077B8 RID: 30648
				public static bool[] DontDrawIfWearingAScarfOrCape = ArmorIDs.Front.Sets.Factory.CreateBoolSet(false, new int[]
				{
					13
				});

				// Token: 0x040077B9 RID: 30649
				public static bool[] IsACape = ArmorIDs.Front.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					2,
					3,
				...
				public static bool[] HidesCompositeShoulders = ArmorIDs.Front.Sets.Factory.CreateBoolSet(false, new int[]
				{
					8,
					11,
					15,
		...
		public class Shoe
		{
			...
			public class Sets
			{
				...
				public static int[] MaleToFemaleID = ArmorIDs.Shoe.Sets.Factory.CreateIntSet(-1, new int[]
				{
					25,
					26
				});
				...
				public static bool[] IsARollerSkate = ArmorIDs.Shoe.Sets.Factory.CreateBoolSet(false, new int[]
				{
					27,
					28,
					29,
		...
		public class Waist
		{
			...
			public class Sets
			{
				...
				public static bool[] UsesTorsoFraming = ArmorIDs.Waist.Sets.Factory.CreateBoolSet(false, new int[]
				{
					5,
					10,
					10,
				...
				public static bool[] IsABelt = ArmorIDs.Waist.Sets.Factory.CreateBoolSet(false, new int[]
				{
					5,
					10,
					10,
		...
		public class Wing
		{
			...
			public class Sets
			{
				...
				public static SetFactory Factory = new SetFactory(ArmorIDs.Wing.Count);

				// Token: 0x040077C2 RID: 30658
				public static WingStats[] Stats;

				// Token: 0x040077C3 RID: 30659
				public static bool[] AlwaysAnimated = ArmorIDs.Wing.Sets.Factory.CreateBoolSet(false, new int[]
				{
					22,
					28,
					45,
		...
		public class Neck
		{
			...
			public class Sets
			{
				...
				public static SetFactory Factory = new SetFactory(ArmorIDs.Neck.Count);

				// Token: 0x040077C5 RID: 30661
				public static bool[] IsAScarf = ArmorIDs.Neck.Sets.Factory.CreateBoolSet(false, new int[]
				{
					8,
					9
				});
		...
		public class Face
		{
			...
			public class Sets
			{
				...
				public static bool[] PreventHairDraw = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					2,
					3,
					4,
				...
				public static bool[] OverrideHelmet = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					2,
					3,
					4,
				...
				public static bool[] DrawInFaceUnderHairLayer = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					5
				});

				// Token: 0x040077CA RID: 30666
				public static bool[] DrawInFaceMaskLayer = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					22
				});

				// Token: 0x040077CB RID: 30667
				public static bool[] DrawInFaceFlowerLayer = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					6,
					9,
				...
				public static bool[] DrawInFaceHeadLayer = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					12,
					10,
					13,
				...
				public static int[] AltFaceHead = ArmorIDs.Face.Sets.Factory.CreateIntSet(-1, new int[]
				{
					12,
					17,
					10,
				...
				public static bool[] CanDrawOnVelociraptorMount = ArmorIDs.Face.Sets.Factory.CreateBoolSet(false, new int[]
				{
					1,
					6,
					9,
		...
		public class Balloon
		{
			...
			public class Sets
			{
				...
				public static bool[] DrawInFrontOfBackArmLayer = ArmorIDs.Balloon.Sets.Factory.CreateBoolSet(false, new int[]
				{
					18
				});

				// Token: 0x040077D1 RID: 30673
				public static bool[] UsesTorsoFraming = ArmorIDs.Balloon.Sets.Factory.CreateBoolSet(false, new int[]
				{
					18
				});
			}
		...
		public class Beard
		{
			...
			public class Sets
			{
				...
				public static bool[] UseHairColor = ArmorIDs.Beard.Sets.Factory.CreateBoolSet(false, new int[]
				{
					2,
					3,
					4
