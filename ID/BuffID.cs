...
namespace Terraria.ID
{
	...
	public class BuffID
	{
		...
		public class Sets
		{
			...
			public static bool[] IsWellFed = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				26,
				206,
				207
			...
			public static bool[] IsFedState = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				26,
				206,
				207,
			...
			public static int[] SortingPriorityFoodBuffs = BuffID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				207,
				4,
				206,
			...
			public static bool[] IsAnNPCWhipDebuff = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				310,
				362
			});
			...
			public static bool[] TimeLeftDoesNotDecrease = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				28,
				334,
				29,
			...
			public static bool[] CanBeRemovedByNetMessage = BuffID.Sets.Factory.CreateBoolSet(new int[0]);

			// Token: 0x04006E52 RID: 28242
			public static bool[] IsAFlaskBuff = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				71,
				72,
				73,
			...
			public static bool[] BuffTimeIsExtendedWithGameDifficulty = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				20,
				22,
				23,
			...
			public static bool[] BuffTimeIsExtendedByDeadCellsPotionStationBuff = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				1,
				2,
				3,
			...
			public static bool[] NurseCannotRemoveDebuff = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				28,
				34,
				87,
			...
			public static int[] AddBuffTimeAdditivelyToCap = BuffID.Sets.Factory.CreateIntSet(0, new int[]
			{
				94,
				600,
				383,
			...
			public static Dictionary<int, IBuffTextHandler> BuffTextHandlers = new Dictionary<int, IBuffTextHandler>
			{
				{
					64,
					new CachedProjectileCounterBuffTextHandler(new int[]
					{
						266
					})
				},
			...
			public static int[] MountType = BuffID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				118,
				6,
				184,
