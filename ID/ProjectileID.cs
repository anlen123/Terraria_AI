...
namespace Terraria.ID
{
	...
	public class ProjectileID
	{
		...
		{
			// Token: 0x0600414B RID: 16715 RVA: 0x006A60CC File Offset: 0x006A42CC
			public static SettingsForCharacterPreview SimpleLoop(int startFrame, int frameCount, int delayPerFrame = 4, bool bounceLoop = false)
			{
				...
				settingsForCharacterPreview.WhenSelected(new int?(startFrame), new int?(frameCount), new int?(delayPerFrame), new bool?(bounceLoop));
				settingsForCharacterPreview.WhenNotSelected(new int?(startFrame), new int?(frameCount), new int?(delayPerFrame), new bool?(bounceLoop));
			...
			public static SettingsForCharacterPreview[] CharacterPreviewAnimations = ProjectileID.Sets.Factory.CreateCustomSet<SettingsForCharacterPreview>(new SettingsForCharacterPreview(), new object[]
			{
				111,
				ProjectileID.Sets.SimpleLoop(0, 6, 4, false).WithOffset(6f, 0f).WhenNotSelected(new int?(0), new int?(0), null, null).WithSpriteDirection(-1),
				112,
				ProjectileID.Sets.SimpleLoop(0, 3, 5, false).WithOffset(6f, 0f).WhenNotSelected(new int?(0), new int?(0), null, null).WithSpriteDirection(-1),
				127,
				ProjectileID.Sets.SimpleLoop(0, 5, 4, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1),
				175,
				ProjectileID.Sets.SimpleLoop(0, 2, 8, false).WhenNotSelected(new int?(0), new int?(2), new int?(10), null).WithOffset(-4f, -6f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				197,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(-8f, -4f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)),
				198,
				ProjectileID.Sets.SimpleLoop(0, 4, 4, false).WhenNotSelected(new int?(0), new int?(4), new int?(4), null).WithOffset(-8f, -20f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				199,
				ProjectileID.Sets.SimpleLoop(0, 8, 6, false).WhenNotSelected(new int?(0), new int?(8), new int?(6), null).WithOffset(-2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				200,
				ProjectileID.Sets.SimpleLoop(0, 6, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-2f, 0f).WithSpriteDirection(-1),
				208,
				ProjectileID.Sets.SimpleLoop(1, 4, 5, false).WhenNotSelected(new int?(1), new int?(4), new int?(7), null).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				209,
				ProjectileID.Sets.SimpleLoop(2, 10, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(6f, 0f).WithSpriteDirection(-1),
				210,
				ProjectileID.Sets.SimpleLoop(1, 6, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(4f, 0f).WithSpriteDirection(-1),
				236,
				ProjectileID.Sets.SimpleLoop(2, 7, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-16f, 0f).WithSpriteDirection(-1),
				268,
				ProjectileID.Sets.SimpleLoop(0, 6, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(4f, 0f).WithSpriteDirection(-1),
				269,
				ProjectileID.Sets.SimpleLoop(0, 4, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(0f, 0f).WithSpriteDirection(-1),
				313,
				ProjectileID.Sets.SimpleLoop(0, 4, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1),
				314,
				ProjectileID.Sets.SimpleLoop(1, 6, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1),
				319,
				ProjectileID.Sets.SimpleLoop(2, 4, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-14f, 0f).WithSpriteDirection(-1),
				324,
				ProjectileID.Sets.SimpleLoop(2, 4, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1),
				334,
				ProjectileID.Sets.SimpleLoop(2, 5, 5, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-10f, 0f).WithSpriteDirection(-1),
				353,
				ProjectileID.Sets.SimpleLoop(2, 8, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(4f, 0f).WithSpriteDirection(-1),
				380,
				ProjectileID.Sets.SimpleLoop(0, 4, 6, false).WithOffset(-10f, -20f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				398,
				ProjectileID.Sets.SimpleLoop(1, 6, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(6f, 0f),
				499,
				ProjectileID.Sets.SimpleLoop(2, 6, 7, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-18f, 0f).WithSpriteDirection(-1),
				653,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(-2f, 0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.CompanionCubePet)),
				703,
				ProjectileID.Sets.SimpleLoop(0, 4, 4, false).WhenNotSelected(new int?(0), new int?(4), new int?(4), null).WithOffset(4f, -10f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				701,
				ProjectileID.Sets.SimpleLoop(0, 3, 6, false).WhenNotSelected(new int?(0), new int?(3), new int?(6), null).WithOffset(-2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				764,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.EtsyPet)),
				765,
				ProjectileID.Sets.SimpleLoop(2, 4, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1),
				774,
				ProjectileID.Sets.SimpleLoop(4, 4, 6, false).WithOffset(-14f, -24f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				825,
				ProjectileID.Sets.SimpleLoop(14, 6, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1),
				821,
				ProjectileID.Sets.SimpleLoop(13, 6, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(0f, 0f).WithSpriteDirection(-1),
				815,
				ProjectileID.Sets.SimpleLoop(0, 6, 6, false).WhenNotSelected(new int?(0), new int?(6), new int?(6), null).WithOffset(-20f, -30f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				816,
				ProjectileID.Sets.SimpleLoop(4, 7, 6, false).WhenNotSelected(new int?(0), new int?(0), null, null).WithOffset(-10f, 0f).WithSpriteDirection(-1),
				817,
				ProjectileID.Sets.SimpleLoop(0, 3, 6, true).WithSpriteDirection(-1).WithOffset(-6f, -12f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				854,
				ProjectileID.Sets.SimpleLoop(0, 4, 6, false).WithOffset(6f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(4), new int?(9), new int?(4), null),
				858,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(-6f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(8), new int?(4), null),
				859,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(4f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(5), new int?(13), new int?(3), null),
				860,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(5), new int?(1), null, null),
				875,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(4f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(0), new int?(7), new int?(4), null),
				881,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WhenSelected(new int?(1), new int?(5), new int?(6), null).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SlimePet)),
				882,
				ProjectileID.Sets.SimpleLoop(0, 6, 5, false).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				883,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)),
				884,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WhenSelected(new int?(2), new int?(7), new int?(5), null),
				885,
				ProjectileID.Sets.SimpleLoop(0, 5, 5, false).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)),
				886,
				ProjectileID.Sets.SimpleLoop(0, 8, 4, false).WithOffset(4f, -16f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				887,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)),
				888,
				ProjectileID.Sets.SimpleLoop(0, 6, 5, false).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				...
				ProjectileID.Sets.SimpleLoop(0, 5, 5, false).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)),
				890,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, 0f).WhenSelected(new int?(2), new int?(6), new int?(5), null),
				892,
				ProjectileID.Sets.SimpleLoop(0, 6, 6, false).WithOffset(-4f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				893,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(0f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)),
				894,
				ProjectileID.Sets.SimpleLoop(0, 8, 4, false).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				897,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, 0f).WhenSelected(new int?(2), new int?(6), new int?(5), null),
				898,
				ProjectileID.Sets.SimpleLoop(0, 16, 5, false).WithOffset(-2f, -16f),
				899,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, 0f).WhenSelected(new int?(2), new int?(7), new int?(4), null),
				900,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(6f, 0f).WhenSelected(new int?(2), new int?(7), new int?(4), null),
				901,
				ProjectileID.Sets.SimpleLoop(0, 5, 4, false).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				934,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WhenSelected(new int?(1), new int?(5), new int?(5), null).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SlimePet)),
				956,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(0f, 0f).WhenSelected(new int?(1), new int?(8), new int?(4), null).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.BerniePet)),
				957,
				ProjectileID.Sets.SimpleLoop(0, 24, 3, false).WithOffset(0f, -14f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				958,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(-2f, 0f).WhenSelected(new int?(5), new int?(8), new int?(4), null),
				959,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WhenSelected(new int?(1), new int?(7), new int?(4), null).WithOffset(4f, 0f),
				960,
				ProjectileID.Sets.SimpleLoop(0, 4, 4, false).WithOffset(4f, 0f).WhenSelected(new int?(5), new int?(7), new int?(4), null),
				994,
				ProjectileID.Sets.SimpleLoop(0, 4, 5, false).WithOffset(2f, 0f).WhenSelected(new int?(5), new int?(7), new int?(5), null),
				998,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(6f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(0), new int?(6), new int?(5), null),
				1003,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(2f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(9), new int?(4), null),
				1004,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(-2f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(7), new int?(4), null),
				1018,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(8f, 0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.CompanionCubePet)),
				1027,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WithOffset(-2f, 0f).WithSpriteDirection(-1).WhenSelected(new int?(0), new int?(4), new int?(5), null),
				1046,
				ProjectileID.Sets.SimpleLoop(6, 4, 6, false).WithOffset(-14f, -24f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				1050,
				ProjectileID.Sets.SimpleLoop(0, 4, 5, false).WhenNotSelected(new int?(0), new int?(4), new int?(5), null).WithOffset(2f, -14f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)),
				1056,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(-4f, 0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SpinWhenWalking)),
				1090,
				ProjectileID.Sets.SimpleLoop(0, 0, 4, false).WithOffset(-4f, 0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SpinWhenWalking)),
				1095,
				ProjectileID.Sets.SimpleLoop(0, 1, 4, false).WhenSelected(new int?(1), new int?(7), new int?(4), null).WithOffset(4f, 0f),
			...
			public static bool[] DontApplyParryDamageBuff = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				524,
				321,
				181,
			...
			public static bool[] BreaksFromToyBreaker = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				1020,
				1105,
				861,
			...
			public static bool[] IsAGravestone = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				202,
				201,
				204,
			...
			public static bool[] CopiesOwnerAttackCDToLocalImmunityOnSpawn = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				1059,
				1060,
				1061,
			...
			public static bool[] IsAPhaseblade = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				1059,
				1060,
				1061,
			...
			public static bool[] IsAWhip = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				847,
				841,
				848,
			...
			public static float[] SummonTagDamageMultiplier = ProjectileID.Sets.Factory.CreateFloatSet(1f, new float[]
			{
				688f,
				0.5f,
				689f,
			...
			public static bool[] AllowsContactDamageFromJellyfish = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				972,
				982,
				984,
			...
			public static bool[] ImmediatelyUpdatesNPCBuffFlags = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				636
			});

			// Token: 0x04006EE5 RID: 28389
			public static bool[] IsAnNPCAttachedExplosive = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				636
			});

			// Token: 0x04006EE6 RID: 28390
			public static bool?[] WindPhysicsImmunity = ProjectileID.Sets.Factory.CreateCustomSet<bool?>(null, new object[]
			{
				20,
				true,
				27,
			...
			public static bool[] RocketsSkipDamageForPlayers = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				338,
				339,
				340,
			...
			public static bool[] IsABombWithFuse = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				28,
				37,
				516,
			...
			public static bool[] IsAGolfBall = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				721,
				739,
				740,
			...
			public static bool[] IsDestroyedByWater = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				85,
				15,
				188,
			...
			public static bool[] FallingBlockDoesNotFallThroughPlatforms = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				71,
				179,
				40,
			...
			public static int[] TrailingMode = ProjectileID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				94,
				0,
				301,
			...
			public static int[] TrailCacheLength = ProjectileID.Sets.Factory.CreateIntSet(10, new int[]
			{
				466,
				20,
				502,
			...
			public static bool[] LightPet = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				18,
				500,
				72,
			...
			public static bool[] DontCancelChannelOnKill = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				190
			});

			// Token: 0x04006EF7 RID: 28407
			public static bool[] CultistIsResistantTo = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				207,
				182,
				338,
			...
			public static bool[] IsADD2Turret = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				663,
				665,
				667,
			...
			public static bool[] TurretFeature = ProjectileID.Sets.Factory.CreateBoolSet(new int[0]);

			// Token: 0x04006EFA RID: 28410
			public static bool[] MinionTargettingFeature = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				191,
				192,
				193,
			...
			public static bool[] MinionSacrificable = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				191,
				192,
				193,
			...
			public static GenSearch[] ExtendedCanHitCheckSearch = ProjectileID.Sets.Factory.CreateCustomSet<GenSearch>(null, new object[]
			{
				833,
				new Searches.Up(3),
				834,
			...
			public static float[] ExtendedCanHitCheckRange = ProjectileID.Sets.Factory.CreateFloatSet(0f, new float[]
			{
				833f,
				48f,
				834f,
			...
			public static bool[] NeedsUUID = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				625,
				626,
				627,
			...
			public static bool[] StardustDragon = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				625,
				626,
				627,
			...
			public static bool[] StormTiger = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				833,
				834,
				835
			...
			public static int[] StormTigerIds = new int[]
			{
				833,
				834,
				835
			...
			public static bool[] IsARocketThatDealsDoubleDamageToPrimaryEnemy = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				134,
				137,
				140,
			...
			public static bool[] IsAMineThatDealsTripleDamageWhenStationary = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				135,
				138,
				141,
			...
			public static bool[] NoLiquidDistortion = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				511,
				512,
				513
			...
			public static bool[] DismountsPlayersOnHit = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				877,
				878,
				879
			...
			public static bool[] NoMeleeSpeedVelocityScaling = ProjectileID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				699,
				707,
				877,
			...
			public static int[] DrawScreenCheckFluff = ProjectileID.Sets.Factory.CreateIntSet(480, new int[]
			{
				461,
				1600,
				632,
			...
			public static bool[] CanHitPastShimmer = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
			{
				605,
				270,
				719,
			...
			public static bool[] TrackMinionSpawnFromItemUse = ProjectileID.Sets.Factory.CreateBoolSet(true, new int[]
			{
				388,
				625,
				627,
