...
namespace Terraria.ID
{
	...
	public class WallID
	{
		...
		public static class Sets
		{
			...
			public static bool[] DualDungeonsJungleBiomeWalls = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				64,
				204,
				205,
			...
			public static bool[] CanBeConvertedToGlowingMushroom = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				64,
				67,
				15,
			...
			public static bool[] AllowsUndergroundDesertEnemiesToSpawn = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				187,
				220,
				222,
			...
			public static bool[] Glass = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				21,
				88,
				89,
			...
			public static bool[] SpreadsCorruption = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				69,
				217,
				220,
			...
			public static bool[] SpreadsCrimson = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				83,
				81,
				218,
			...
			public static bool[] SpreadsHallow = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				70,
				219,
				222,
			...
			public static bool[] AllowsWind = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				0,
				150,
				138,
			...
			public static bool[] Fences = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				150,
				138,
				145,
			...
			public static bool[] AllowsPlantsToGrow = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				0,
				150,
				138,
			...
			public static bool[] CannotBeReplacedByWallSpread = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				4,
				40,
				3,
			...
			public static bool[] WallSpreadStopsAtAir = WallID.Sets.Factory.CreateBoolSet(new int[]
			{
				63,
				62
			});
			...
			public static int[] BlendType = WallID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				66,
				63,
				68,
			...
			public static ushort[] WallTypeToTerrainTileType = WallID.Sets.Factory.CreateUshortSet(0, new ushort[]
			{
				40,
				147,
				71,
			...
			public static class Conversion
			{
				...
				public static bool[] Dirt = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					2,
					16
				});
				...
				public static bool[] Snow = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					40,
					249
				});
				...
				public static bool[] Ice = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					71,
					266
				});
				...
				public static bool[] PureSand = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					216,
					187,
					304,
				...
				public static bool[] NewWall1 = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					188,
					192,
					200,
				...
				public static bool[] NewWall2 = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					189,
					193,
					201,
				...
				public static bool[] NewWall3 = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					190,
					194,
					202,
				...
				public static bool[] NewWall4 = WallID.Sets.Factory.CreateBoolSet(new int[]
				{
					191,
					195,
					203,
