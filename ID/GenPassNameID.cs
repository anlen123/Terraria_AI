...
namespace Terraria.ID
{
	...
	public static class GenPassNameID
	{
		...
		public static readonly string CaveWallVariety = "Wall Variety";

		// Token: 0x0400173F RID: 5951
		public static readonly string LifeCrystals = "Life Crystals";

		// Token: 0x04001740 RID: 5952
		public static readonly string Statues = "Statues";

		// Token: 0x04001741 RID: 5953
		public static readonly string UndergroundHousesAndBuriedChests = "Buried Chests";

		// Token: 0x04001742 RID: 5954
		public static readonly string SurfaceChests = "Surface Chests";

		// Token: 0x04001743 RID: 5955
		public static readonly string ChestsInJungleShrines = "Jungle Chests Placement";

		// Token: 0x04001744 RID: 5956
		public static readonly string UnderwaterChests = "Water Chests";

		// Token: 0x04001745 RID: 5957
		public static readonly string SpiderCaves = "Spider Caves";

		// Token: 0x04001746 RID: 5958
		public static readonly string GemCaves = "Gem Caves";

		// Token: 0x04001747 RID: 5959
		public static readonly string MossAndMossCaves = "Moss";

		// Token: 0x04001748 RID: 5960
		public static readonly string LihzahrdTemplePart2 = "Temple";

		// Token: 0x04001749 RID: 5961
		public static readonly string CaveWallsInEnclosedSpaces = "Cave Walls";

		// Token: 0x0400174A RID: 5962
		public static readonly string UndergroundJungleTrees = "Jungle Trees";

		// Token: 0x0400174B RID: 5963
		public static readonly string FloatingIslandHouses = "Floating Island Houses";

		// Token: 0x0400174C RID: 5964
		public static readonly string QuickCleanup = "Quick Cleanup";

		// Token: 0x0400174D RID: 5965
		public static readonly string PotsGraveyardsAndBoulderPiles = "Pots";

		// Token: 0x0400174E RID: 5966
		public static readonly string Hellforges = "Hellforge";

		// Token: 0x0400174F RID: 5967
		public static readonly string SpreadingGrassOnSurfaceSunflowersEvilsOnSurfaceAndLavaCleanup = "Spreading Grass";

		// Token: 0x04001750 RID: 5968
		public static readonly string SurfaceOreAndStone = "Surface Ore and Stone";

		// Token: 0x04001751 RID: 5969
		public static readonly string FallenLogsAndWaterFeatures = "Place Fallen Log";
