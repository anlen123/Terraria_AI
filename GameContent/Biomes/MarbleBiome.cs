...
namespace Terraria.GameContent.Biomes
{
	...
	{
		// Token: 0x06003626 RID: 13862 RVA: 0x00622D48 File Offset: 0x00620F48
		...
		// Token: 0x06003627 RID: 13863 RVA: 0x00622ED8 File Offset: 0x006210D8
		...
		// Token: 0x06003628 RID: 13864 RVA: 0x00623068 File Offset: 0x00621268
		...
		// Token: 0x06003629 RID: 13865 RVA: 0x006230A8 File Offset: 0x006212A8
		...
		// (Invoke) Token: 0x0600498A RID: 18826
		private delegate bool SlabState(int x, int y, int scale);

		// Token: 0x02000998 RID: 2456
		private static class SlabStates
		{
			// Token: 0x0600498D RID: 18829 RVA: 0x001DA9FB File Offset: 0x001D8BFB
			public static bool Empty(int x, int y, int scale)
			{
				return false;
			}

			// Token: 0x0600498E RID: 18830 RVA: 0x000379F1 File Offset: 0x00035BF1
			public static bool Solid(int x, int y, int scale)
			{
				return true;
			}

			// Token: 0x0600498F RID: 18831 RVA: 0x006D0D31 File Offset: 0x006CEF31
			public static bool HalfBrick(int x, int y, int scale)
			{
				return y >= scale / 2;
			}

			// Token: 0x06004990 RID: 18832 RVA: 0x006D0D3C File Offset: 0x006CEF3C
			public static bool BottomRightFilled(int x, int y, int scale)
			{
				return x >= scale - y;
			}

			// Token: 0x06004991 RID: 18833 RVA: 0x006D0D47 File Offset: 0x006CEF47
			public static bool BottomLeftFilled(int x, int y, int scale)
			{
				return x < y;
			}

			// Token: 0x06004992 RID: 18834 RVA: 0x006D0D4D File Offset: 0x006CEF4D
			public static bool TopRightFilled(int x, int y, int scale)
			{
				return x > y;
			}

			// Token: 0x06004993 RID: 18835 RVA: 0x006D0D53 File Offset: 0x006CEF53
		...
		private struct Slab
		{
			...
			// (get) Token: 0x06004994 RID: 18836 RVA: 0x006D0D5B File Offset: 0x006CEF5B
			public bool IsSolid
			{
				get
				{
			...
			// Token: 0x06004995 RID: 18837 RVA: 0x006D0D74 File Offset: 0x006CEF74
			...
			// Token: 0x06004996 RID: 18838 RVA: 0x006D0D84 File Offset: 0x006CEF84
			public MarbleBiome.Slab WithState(MarbleBiome.SlabState state)
			{
				return new MarbleBiome.Slab(state, this.HasWall);
			}

			// Token: 0x06004997 RID: 18839 RVA: 0x006D0D92 File Offset: 0x006CEF92
