...
namespace Terraria.GameContent.Generation.Dungeon.Entrances
{
	...
	{
		// Token: 0x0600351C RID: 13596 RVA: 0x0061348C File Offset: 0x0061168C
		public TowerDungeonEntrance(DungeonEntranceSettings settings) : base(settings)
		{
		}

		// Token: 0x0600351D RID: 13597 RVA: 0x00613495 File Offset: 0x00611695
		...
		// Token: 0x0600351E RID: 13598 RVA: 0x006134AF File Offset: 0x006116AF
		...
		// Token: 0x0600351F RID: 13599 RVA: 0x006134CA File Offset: 0x006116CA
		...
		// Token: 0x06003520 RID: 13600 RVA: 0x006134F4 File Offset: 0x006116F4
		public void TowerEntrance(DungeonData data, int i, int j, bool generating)
		{
			...
			if (generating && !dungeonEntranceIsBuried && !dungeonEntranceIsUnderground)
			{
				...
				WorldUtils.Gen(new Point(x, num7 - 15), new Shapes.Circle(15, 15), Actions.Chain(new GenAction[]
				{
					new Actions.Clear()
				}));
			}
			this.Bounds.UpdateBounds(i - num4, minY, i + num4 + 1, maxY);
			if (generating)
			{
				int num18 = -5;
				int num19 = num5;
				...
				for (int num26 = -num4; num26 <= num4; num26++)
				{
					...
					for (int num28 = 0; num28 <= num16; num28++)
					{
						...
						if (WorldGen.InWorld(num27, num29, 5))
						{
							...
							else if (num28 >= num12 - num2 && num28 <= num16 && num26 >= -num14 && num26 <= num14)
							{
		...
		// Token: 0x06003521 RID: 13601 RVA: 0x00614300 File Offset: 0x00612500
		...
		// Token: 0x06003522 RID: 13602 RVA: 0x00614428 File Offset: 0x00612628
		...
		// Token: 0x06003523 RID: 13603 RVA: 0x00614464 File Offset: 0x00612664
		...
		// Token: 0x06003524 RID: 13604 RVA: 0x00614560 File Offset: 0x00612760
		...
		// Token: 0x06003525 RID: 13605 RVA: 0x00614608 File Offset: 0x00612808
