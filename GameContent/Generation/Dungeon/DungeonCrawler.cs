...
namespace Terraria.GameContent.Generation.Dungeon
{
	...
	public static class DungeonCrawler
	{
		...
		// (get) Token: 0x0600336B RID: 13163 RVA: 0x005F6CF2 File Offset: 0x005F4EF2
		// (set) Token: 0x0600336C RID: 13164 RVA: 0x005F6D03 File Offset: 0x005F4F03
		...
		// Token: 0x0600336D RID: 13165 RVA: 0x005F6D18 File Offset: 0x005F4F18
		public static void SetupDungeonData(int currentDungeon, bool clearOld = false)
		{
			...
			DungeonCrawler.dungeonData.Add(item);
		}

		// Token: 0x0600336E RID: 13166 RVA: 0x005F6D68 File Offset: 0x005F4F68
		public static void SetupDungeonGenVarVariables(DungeonGenVars genVars, UnifiedRandom genRand)
		{
			...
			case 0:
				...
				genVars.windowPlatformItemTypes = new int[]
				{
					1386
				};
				goto IL_120;
		...
		// Token: 0x0600336F RID: 13167 RVA: 0x005F7218 File Offset: 0x005F5418
		...
		// Token: 0x06003370 RID: 13168 RVA: 0x005F76C4 File Offset: 0x005F58C4
		public static void MakeDungeon(int x, int y, GenerationProgress progress = null)
		{
			...
			if (currentDungeonData.Type == DungeonType.DualDungeon)
			{
				...
				}).ProvideLayout(currentDungeonData, progress, genRand, ref num2);
			...
			Vector2 vector = new Vector2((float)innerBounds.Center.X, (float)innerBounds.Top);
			float x2 = vector.X;
			float y2 = vector.Y;
			if (currentDungeonData.Type == DungeonType.Default)
			{
				for (int i = 1; i < currentDungeonData.dungeonRooms.Count; i++)
				{
					if (currentDungeonData.dungeonRooms[i].generated)
					{
						...
						vector = new Vector2((float)innerBounds.Center.X, (float)innerBounds.Top);
						if (vector.Y < y2)
						{
							x2 = vector.X;
							y2 = vector.Y;
			...
			Vector2D target;
			target..ctor((double)currentDungeonData.genVars.generatingDungeonPositionX, (double)currentDungeonData.genVars.generatingDungeonPositionY);
			double num3 = flag ? dungeonEntrancePosition.Distance(target) : 0.0;
			int num4 = (int)num3;
			int num5 = 100;
			while (!currentDungeonData.createdDungeonEntranceOnSurface)
			{
				...
				if (num2 == 0 && genRand.Next(5) == 0 && (double)currentDungeonData.genVars.generatingDungeonPositionY > Main.worldSurface + 100.0)
				{
					num2 = 10;
				...
				if (flag)
				{
					DungeonCrawler.MakeDungeon_GenerateNextEntranceHall_Precalculated(currentDungeonData, genRand, num3, dungeonEntrancePosition, ref num4, ref target);
				}
				else
				{
		...
		// Token: 0x06003371 RID: 13169 RVA: 0x005F7E6C File Offset: 0x005F606C
		...
		// Token: 0x06003372 RID: 13170 RVA: 0x005F7EBC File Offset: 0x005F60BC
		...
		// Token: 0x06003373 RID: 13171 RVA: 0x005F7F74 File Offset: 0x005F6174
		public static DungeonRoomSettings MakeDungeon_GetRoomSettings(DungeonRoomType roomType, DungeonData data, DungeonControlLine line)
		{
			...
			case DungeonRoomType.LivingTree:
			{
				...
				int num8 = num4 * 6 + num5;
				int num9 = 4 + genRand.Next(3);
				int boundingRadius = (num8 + num9 + num9) / 2;
			...
			case DungeonRoomType.GenShapeCircle:
			{
				...
				int num10 = num;
				int num11 = num10 + 8;
				DungeonShapes.CircleRoom innerShape = new DungeonShapes.CircleRoom(num10 + num2);
				DungeonShapes.CircleRoom outerShape = new DungeonShapes.CircleRoom(num11 + num2);
				dungeonRoomSettings = new GenShapeDungeonRoomSettings
				{
					ShapeType = GenShapeType.Circle,
					InnerShape = innerShape,
					OuterShape = outerShape,
					BoundingRadius = num11 + num2,
			...
			case DungeonRoomType.GenShapeMound:
			{
				...
				int num12 = num + num2;
				int num13 = num12 + 8;
				DungeonShapes.MoundRoom innerShape2 = new DungeonShapes.MoundRoom(num12, (int)((double)num12 * 1.5));
				DungeonShapes.MoundRoom outerShape2 = new DungeonShapes.MoundRoom(num13, (int)((double)num13 * 1.5));
				dungeonRoomSettings = new GenShapeDungeonRoomSettings
				{
					ShapeType = GenShapeType.Mound,
					InnerShape = innerShape2,
					OuterShape = outerShape2,
					BoundingRadius = (int)((double)num13 * 1.2)
				};
				break;
			}
			case DungeonRoomType.GenShapeHourglass:
			{
				...
				int num14 = num + num2 + 10;
				int num15 = num + num3 + 10;
				int num16 = num14 + 16;
				int num17 = num15 + 16;
				DungeonShapes.HourglassRoom innerShape3 = new DungeonShapes.HourglassRoom(num14, num15, 0f);
				DungeonShapes.HourglassRoom outerShape3 = new DungeonShapes.HourglassRoom(num16, num17, 0.4f);
				dungeonRoomSettings = new GenShapeDungeonRoomSettings
				{
					ShapeType = GenShapeType.Hourglass,
					InnerShape = innerShape3,
					OuterShape = outerShape3,
					BoundingRadius = ((num16 > num17) ? (num16 / 2) : (num17 / 2)) + 5,
			...
			case DungeonRoomType.GenShapeDoughnut:
			{
				...
				int num20 = num18 + 8;
				int num21 = num19 + 8;
				DungeonShapes.CircleRoom innerShape4 = new DungeonShapes.CircleRoom(num18, num19);
				DungeonShapes.CircleRoom outerShape4 = new DungeonShapes.CircleRoom(num20, num21);
				dungeonRoomSettings = new GenShapeDungeonRoomSettings
				{
					ShapeType = GenShapeType.Doughnut,
					InnerShape = innerShape4,
					OuterShape = outerShape4,
					BoundingRadius = ((num20 > num21) ? num20 : num21) + 5,
					HallwayPointAdjuster = new int?(5)
				};
				break;
			}
			case DungeonRoomType.GenShapeQuadCircle:
			{
				...
				int num22 = Math.Max(5, (int)((float)(num + num2) * 0.5f * 0.75f));
				int num23 = num22 + 8;
				int num24 = (int)((float)num22 * 1.5f);
				DungeonShapes.QuadCircleRoom innerShape5 = new DungeonShapes.QuadCircleRoom(num22, num24);
				DungeonShapes.QuadCircleRoom outerShape5 = new DungeonShapes.QuadCircleRoom(num23, num24);
				dungeonRoomSettings = new GenShapeDungeonRoomSettings
				{
					ShapeType = GenShapeType.QuadCircle,
					InnerShape = innerShape5,
					OuterShape = outerShape5,
					BoundingRadius = num23 / 2 + num24 + 4,
					HallwayPointAdjuster = new int?(5)
				};
				break;
			}
		...
		// Token: 0x06003374 RID: 13172 RVA: 0x005F84A0 File Offset: 0x005F66A0
		...
		// Token: 0x06003375 RID: 13173 RVA: 0x005F8591 File Offset: 0x005F6791
		...
		// Token: 0x06003376 RID: 13174 RVA: 0x005F85B4 File Offset: 0x005F67B4
		...
		// Token: 0x06003377 RID: 13175 RVA: 0x005F86D4 File Offset: 0x005F68D4
		...
		// Token: 0x06003378 RID: 13176 RVA: 0x005F870C File Offset: 0x005F690C
		...
		// Token: 0x06003379 RID: 13177 RVA: 0x005F87B5 File Offset: 0x005F69B5
		...
		// Token: 0x0600337A RID: 13178 RVA: 0x005F87C4 File Offset: 0x005F69C4
		...
		// Token: 0x0600337B RID: 13179 RVA: 0x005F883C File Offset: 0x005F6A3C
