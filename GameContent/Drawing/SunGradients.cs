...
namespace Terraria.GameContent.Drawing
{
	...
	{
		// Token: 0x0600309C RID: 12444 RVA: 0x005BA87B File Offset: 0x005B8A7B
		...
		{
			new BackgroundGradientDrawer(new Color(116, 191, 255), () => Main.bgAlphaFrontLayer[0], () => Main.treeBGSet1, new int[]
			{
				176
			}),
			new BackgroundGradientDrawer(new Color(157, 192, 255), () => Main.bgAlphaFrontLayer[0], () => Main.treeBGSet1, new int[]
			{
				179
			}),
			new BackgroundGradientDrawer(new Color(116, 191, 255), () => Main.bgAlphaFrontLayer[10], () => Main.treeBGSet2, new int[]
			{
				176
			}),
			new BackgroundGradientDrawer(new Color(157, 192, 255), () => Main.bgAlphaFrontLayer[10], () => Main.treeBGSet2, new int[]
			{
				179
			}),
			new BackgroundGradientDrawer(new Color(116, 191, 255), () => Main.bgAlphaFrontLayer[11], () => Main.treeBGSet3, new int[]
			{
				176
			}),
			new BackgroundGradientDrawer(new Color(157, 192, 255), () => Main.bgAlphaFrontLayer[11], () => Main.treeBGSet3, new int[]
			{
				179
			}),
			new BackgroundGradientDrawer(new Color(116, 191, 255), () => Main.bgAlphaFrontLayer[12], () => Main.treeBGSet4, new int[]
			{
				176
			}),
			new BackgroundGradientDrawer(new Color(157, 192, 255), () => Main.bgAlphaFrontLayer[12], () => Main.treeBGSet4, new int[]
			{
				179
			}),
			new BackgroundGradientDrawer(new Color(184, 211, 245), () => Main.bgAlphaFrontLayer[2], () => Main.desertBackgroundSet.Pure.Backgrounds, new int[]
			{
				248
			}),
			new BackgroundGradientDrawer(new Color(169, 241, 255), () => Main.bgAlphaFrontLayer[7], () => Main.snowBG, new int[]
			{
				263,
				268,
				269
			}),
			new BackgroundGradientDrawer(new Color(220, 255, 109), () => Main.bgAlphaFrontLayer[3], () => Main.jungleBG, new int[]
			{
				59
			}),
			new BackgroundGradientDrawer(new Color(141, 232, 131), () => Main.bgAlphaFrontLayer[3], () => Main.jungleBG, new int[]
			{
				284
			}),
			new BackgroundGradientDrawer(new Color(157, 192, 255), () => Main.bgAlphaFrontLayer[4], new BackgroundArrayGetterMethod(SunGradients.Ocean), new int[]
			{
				283
			})
		};
