...
namespace Terraria.GameContent.RGB
{
	...
	{
		// Token: 0x060025E5 RID: 9701 RVA: 0x0055A03C File Offset: 0x0055823C
		...
		// Token: 0x060025E6 RID: 9702 RVA: 0x0055A084 File Offset: 0x00558284
		...
		// Token: 0x060025E7 RID: 9703 RVA: 0x00009E06 File Offset: 0x00008006
		public override void Present()
		{
		}

		// Token: 0x060025E8 RID: 9704 RVA: 0x0055B7AC File Offset: 0x005599AC
		public override void Render(IEnumerable<RgbKey> keys)
		{
			foreach (RgbKey rgbKey in keys)
			{
				int num;
				if (this._keyCodeMap.TryGetValue(rgbKey.Key, out num))
				{
