...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x0600157F RID: 5503 RVA: 0x004C8608 File Offset: 0x004C6808
		public static void Load()
		{
			...
			achievement.AddConditions(new AchievementCondition[]
			{
				NPCKilledCondition.Create(-4)
			});
			achievement.UseConditionsCompletedTracker();
			Main.Achievements.Register(achievement);
		...
		// Token: 0x06001580 RID: 5504 RVA: 0x004CAF24 File Offset: 0x004C9124
